...
public class Exercises {
    ...
    /* Escreva um código onde o usuário entra com sua altura e peso, seja feito o cálculo do seu
    ...
    pares ou ímpares (de acordo com a seleção inicial) no intervalo de números informados, incluindo
    os números informados e em ordem decrescente;
     */

    /* Escreva um código onde o usuário informa um número inicial, posteriormente irá informar
    outros N números, a execução do código irá continuar até que o número informado dividido pelo
    primeiro número tenha resto diferente de 0 na divisão, números menores que o primeiro número
    devem ser ignorados.
     */
        ...
        while(keepVerify){
            ...
            // Outra sugestão - if(result != 0) break;
        }
    }
}
